...
def generate_launch_description():
    ...
    # ROS parameter
    imu_topic_arg                     = DeclareLaunchArgument('imu_topic',        default_value = '/tractor/novatel/imu/data_raw',description = '')
    ...
    imu_radar_position_offset_x_arg   = DeclareLaunchArgument('imu_radar_position_offset_x',default_value = '-0.6809',description = '')
    imu_radar_position_offset_y_arg   = DeclareLaunchArgument('imu_radar_position_offset_y',default_value = '0.3871',description = '')
    imu_radar_position_offset_z_arg   = DeclareLaunchArgument('imu_radar_position_offset_z',default_value = '1.0733',description = '')

    imu_radar_quaternion_offset_w_arg = DeclareLaunchArgument('imu_radar_quaternion_offset_w',default_value = '0.9999', description = '')
    imu_radar_quaternion_offset_x_arg = DeclareLaunchArgument('imu_radar_quaternion_offset_x',default_value = '-0.0196',description = '')
    imu_radar_quaternion_offset_y_arg = DeclareLaunchArgument('imu_radar_quaternion_offset_y',default_value = '0.0245', description = '')
    imu_radar_quaternion_offset_z_arg = DeclareLaunchArgument('imu_radar_quaternion_offset_z',default_value = '-0.9995',description = '')
    ...
    success_prob_arg                  = DeclareLaunchArgument('success_prob',    default_value = '0.999',description = '')
    ...
    icp_std_y_arg                     = DeclareLaunchArgument('icp_std_y',                  default_value = '0.5',       description = 'variance')  
