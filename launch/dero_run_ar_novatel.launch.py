...
def generate_launch_description():
    params = [PathJoinSubstitution([CONFIG_COMMON_DIR, "dero_ar_novatel.yaml"])] #dero_carried_1
    ...
    dero = Node(
        ...
        remappings=[
            ("/input_imu", "/tractor/novatel/imu/data_raw"), # /sensor_platform/imu /tractor/lidar/front/imu/sync
