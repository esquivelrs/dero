...
def generate_launch_description():
    est_save_dir_arg = DeclareLaunchArgument('est_save_dir',default_value = '/home/ros/rosbags_shared/scekf_dero_carried_1_est2.txt',description = '')
    bag_dir_arg      = DeclareLaunchArgument('bag_dir',     default_value = '/home/ros/rosbags_shared/radar_inertial_datasets_icins_2021/carried_datasets/ros2/ros2.db3',description = '');
